...
SUBROUTINE ReadInputfile(system, hydrau, siteMeteo, HW, DB, stochRate, topo, siteSolar)
	...
	USE Class_SourceIn
	USE Class_Rates
	USE Class_WaterQuality, ONLY:WaterQuality_type
	...
	TYPE(WaterQuality_type), DIMENSION(:), ALLOCATABLE :: HwIn	!HEADWATERS
	TYPE(WaterQuality_type), DIMENSION(:),	POINTER :: DBin		!Downstream bondary
	...
	READ(8,*) timezone, pco2, dtuser, tf, IMeth, IMethpH, simHyporheicWQ, showDielResults, stateVariables, calcSedFlux, simAlk, writeDynamic
